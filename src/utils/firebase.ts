...
import { getFirestore, collection, addDoc, getDoc, doc, setDoc, deleteDoc, updateDoc, query, getDocs, onSnapshot, where } from "firebase/firestore";
...
export { db, app, collection, addDoc, getDoc, getDocs, doc, where, setDoc, deleteDoc, updateDoc, query, onSnapshot, auth, provider, signInWithRedirect, getRedirectResult, onAuthStateChanged, signOut} ;