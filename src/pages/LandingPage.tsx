import {Box, HStack, VStack, Stack, Text, Avatar, Center, Image, Flex, Container, Heading, Button, Card} from '@chakra-ui/react'
...
const LandingPage = () => {
  ...
  return (
    ...
    <Container  maxWidth={'1400px'} minH={'100vh'} px={12}>
      ...
      <Flex minH={'550px'} >
        <Box flex={1}>
          <Heading as='h2' pt={'100px'} pb={'34px'} fontSize={'48px'} fontWeight={700}  lineHeight={'72px'}> About Chatter</Heading>
        ...
        <Box width={'42%'} display={'flex'} flexDir={'column'} justifyContent={'center'} alignItems={'center'}>
          <Image src={AboutImage} alt='aboutImage' objectFit='contain'  boxSize='500px'></Image>
        </Box>
      </Flex>
      ...
      <VStack minH={'500px'} mx={'100px'} pb={'70px'}>
        ...
        <HStack spacing={12}>
          <Card width={'300px'} p={4}  height={'300px'} border={'1px solid grey'}>
            <Box borderRadius='100px' bg={'gray.100'} width={'70px'} height={'70px'} p={3} display={'flex'} justifyContent={'center'} alignItems={'center'}>
                <Image w={'30px'} src={Analytics}></Image>
            </Box>
             <Heading as='h3' fontSize={'24px'} py={'15px'}>Analytics</Heading>
             <Text fontSize={'18px'}>Analytics to track the number of views, likes and comment and also analyze the performance of your articles over a period of time</Text>
          </Card>
          <Card  width={'300px'} p={4} height={'300px'} border={'1px solid grey'} >
            <Box borderRadius='100px' bg={'gray.100'} width={'70px'} height={'70px'} p={3} display={'flex'} justifyContent={'center'} alignItems={'center'}>
              <Image w={'30px'} src={Social}></Image>
            </Box>
            <Heading as='h3' fontSize={'24px'} py={'15px'}>Social interactions</Heading>
            <Text fontSize={'18px'}>Users on the platform can interact with posts they like, comment and engage in discussions</Text>
          ...
          <Card  width={'300px'} p={4} height={'300px'} border={'1px solid grey'}>
            ...
            <Heading as='h3' fontSize={'24px'} py={'15px'}>Content creation</Heading>
            <Text fontSize={'18px'}>Write nice and appealing with our in-built markdown, a rich text editor</Text>
          </Card>
        </HStack>
      </VStack> 
    </Container> 
        ...
        <Box  minH={'400px'} bg={'#FFEDCC80'} px={6} display={'flex'} >
          <Center w={'400px'}  display={'flex'} justifyContent={'center'} alignItems={'center'} >
            <Image w={'250pxpx'} h={'250px'} borderRadius={'150px'} src={Testimonial} alt='testmonial person'/>
          </Center>
          <Box flex={1} >
            <Text fontSize={'18px'} width={'90%'} pb={'48px'} mt={'80px'} > "Chatter has become an integral part of my online experience. As a user of this incredible blogging platform, I have discovered a vibrant community of individuals who are passionate about sharing their ideas and engaging in thoughtful discussions.” </Text>
        ...
        <Box minH={'500px'}  display={'flex'} px={10} >
          <Box width={'500px'} >
            <HStack  h={'450px'} mt={'25px'} >
              <VStack flex={1} gap={'50px'}   h={'450px'} justifyContent={'center'} alignItems={'flex-end'} >
                <Image  src={Getstarted1} w={'150px'} h={'150px'} borderRadius={'100px'}/>
                <Image src={Getstarted2} w={'150px'} h={'150px'} borderRadius={'100px'}/>
              </VStack>
              <Box flex={1}  >
                <Image src={Getstarted3} w={'150px'} h={'150px'} borderRadius={'100px'}/>
              </Box>
            </HStack>
